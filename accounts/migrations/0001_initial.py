    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('city_planner', 'City Planner'), ('research', 'Research')], default='research', max_length=20)),
                ('status', models.CharField(choices=[('pending', 'Pending'), ('active', 'Active'), ('denied', 'Denied')], default='pending', max_length=20)),
